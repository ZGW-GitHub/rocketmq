...
/**
 * 一个 ConsumerGroup 对应一个 MQConsumerInner
 */
public class DefaultMQPushConsumerImpl implements MQConsumerInner {
    ...
    public void pullMessage(final PullRequest pullRequest) {
        ...
        if (!this.consumeOrderly) { // 不是顺序消费
            // TODO 检查当前快照内 msgMaxOffset - msgMinOffset 是否大于了 并发最大跨度偏移
            ...
            if (processQueue.isLocked()) {
                if (!pullRequest.isLockedFirst()) { // 不是 LockedFirst
                    final long offset = this.rebalanceImpl.computePullFromWhere(pullRequest.getMessageQueue()); // 设置从哪里开始消费
                    ...
                    pullRequest.setLockedFirst(true); // 设置 LockedFirst ，新建的 pullRequest 是 false
        ...
        PullCallback pullCallback = new PullCallback() {
                    ...
                    switch (pullResult.getPullStatus()) {
                        case FOUND: // 拉取到了消息
                            ...
                            if (pullResult.getMsgFoundList() == null || pullResult.getMsgFoundList().isEmpty()) {
                                ...
                                // 将拉取到的消息存入 MessageQueue 对应的 ProcessQueue 中
                                ...
                                if (DefaultMQPushConsumerImpl.this.defaultMQPushConsumer.getPullInterval() > 0) {
                                    // 将 PullRequest 延迟放入 pullRequestQueue 队列
                                    ...
                                    // 将 PullRequest 立即放入 pullRequestQueue 队列
                                    DefaultMQPushConsumerImpl.this.executePullRequestImmediately(pullRequest);
                                }
                            }
                        ...
                        case NO_MATCHED_MSG: // 没有匹配的消息
                            ...
                            // 将 PullRequest 立即放入 pullRequestQueue 队列，PullMessageService 会取出并再次发起拉取消息的请求
                            DefaultMQPushConsumerImpl.this.executePullRequestImmediately(pullRequest);
                            break;
            ...
            public void onException(Throwable e) {
                ...
                // 将 PullRequest 延迟放入 pullRequestQueue 队列，PullMessageService 会取出并再次发起拉取消息的请求
        ...
        int sysFlag = PullSysFlag.buildSysFlag(
            commitOffsetEnable, // commitOffset 该标识会使 broker 收到 pullRequest 时更新 MessageQueue 的消费进度(即: offset)
            true, // suspend
    ...
    public void sendMessageBack(MessageExt msg, int delayLevel, final String brokerName) throws RemotingException, MQBrokerException, InterruptedException, MQClientException {
        try {
            ...
            this.mQClientFactory.getMQClientAPIImpl()
                    .consumerSendMessageBack(brokerAddr, msg, this.defaultMQPushConsumer.getConsumerGroup(), delayLevel, 5000, getMaxReconsumeTimes());
        } catch (Exception e) {
    ...
    public synchronized void start() throws MQClientException {
        switch (this.serviceState) {
            case CREATE_JUST:
                ...
                // 创建 MQClientManager 实例（这里面会创建 PullMessageService）
        ...
        this.updateTopicSubscribeInfoWhenSubscriptionChanged(); // 更新订阅的 Topic 的信息
